                    ...
                    <table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="{{route('admin.restore-printing', $user->id)}}" title="Edit"><i class="fa fa-pencil m-r-5"></i> Aktifkan</a></td>
                                @elseif($user->status==1)
                                <td>Aktif</td>
                                <td><a href="{{route('admin.banned-printing', $user->id)}}" title="Delete"><i class="fa fa-trash-o m-r-5"></i> Banned</a></td>
