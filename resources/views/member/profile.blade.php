			...
			<div class="row" style="background-color: #FFF ; padding: 5%">
                <div class="col-md-6 col-sm-6">
                    ...
                    <ul id="profile_summary" class="font-12pt">
                        ...
                        <li>Nama <span>{{$member->nama}}</span>
                        </li>
                        @else
                        <li>Nama <span style="color: #e04f67">Lengkapi Data Anda.</span>
                        </li>
                        @endif
                        <li>Email <span>{{$member->email}}</span>
                        </li>
                        <li>Username <span>{{$member->username}}</span>
                        </li>
                        </li>
                    </ul>
                </div>
                <div class="col-md-6 col-sm-6">
                    ...
                    @else
                    <img src="{{ URL::asset($member->foto) }}" alt="Image" class="img-responsive styled profile_pic" style="min-height: 200px; max-width: 500px; max-height: 250px">
                    @endif
                </div>
                <div class="col-md-6 col-sm-6">
                    <a href="/member/profile/{{$id}}/edit"><button type="button" class="btn btn-primary">Edit Profile</button></a>
                </div>
            </div>
