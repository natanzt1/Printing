		...
		<div class="margin_60 container" style="padding: 5%">
			...
			<div class="row" style="background-color: #FFF ; padding: 5%">
                <div class="col-md-12 col-sm-12">
                    ...
                    <form method="POST" action="{{route('printing.storeJenis')}}">
                        @csrf
                        <div class="form-group">
                            <label for="jenis">Jenis Printing Yang Sudah Terdaftar</label><br>
                        ...
                        <div class="form-group">
                            <label for="kertas">Jenis Layanan Baru</label><br>
                            <input type="text" class="form-control" name="jenis_printing" placeholder="Contoh : Banner, Poster" required>
                        </div>
